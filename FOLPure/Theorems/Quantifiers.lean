...
import FOLPure.FOL
import FOLPure.Theorems.Impl
import FOLPure.Theorems.Neg
import FOLPure.Theorems.Derived

namespace FOLPure.Theorems.Quantifiers
...
theorem forall_dni {Γ A} : Γ ⊢ .impl (.forall A) (.forall (neg (neg A))) := by
  ...
  · exact FOLPure.Theorems.Neg.double_neg_intro
...
end FOLPure.Theorems.Quantifiers

export FOLPure.Theorems.Quantifiers (
