/-
  Formalización de Lógica de Primer Orden pura (FOL, sin igualdad) en Lean 4.
  ...
  Nota: Esta es la versión FOL pura. Para la versión con igualdad (FOL^=),
  véase la librería FOL.
-/
