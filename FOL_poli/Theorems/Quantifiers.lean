...
namespace FOL_poli.Theorems.Quantifiers
...
theorem forall_dni {Γ A} : Γ ⊢ .impl (.forall A) (.forall (neg (neg A))) := by
  ...
  · exact FOL_poli.Theorems.Neg.double_neg_intro
...
end FOL_poli.Theorems.Quantifiers

export FOL_poli.Theorems.Quantifiers (
