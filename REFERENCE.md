...
| `SkolemNF0.lean` | 🏁 **forma normal de Skolem**: `derives0_of_skolemNF`, `skolem_conservative_nf`; ⭐ `skolemizeF_impAll` y `skolemNF_shape` **sin `choice`**, `occursFormula_lift` **net‑0 puro** | ``propext, Classical.choice, Quot.sound`` | **062** |
