...
| `SkolemHerbrand0.lean` | 🏁 **el enchufe**: `herbrand_of_skolemNF`, `derives0_neg_allBlock_iff` | ``propext, Quot.sound`` | **066** |
...
**`SkolemHerbrand0.lean`** — **`impAll_neg_allBlock`**, `impAll_ex_neg_not_forall`, `impAll_exBlock_neg`, **`derives0_neg_allBlock_iff`**, `quantFree_neg`, **`herbrand_of_skolemNF`**
