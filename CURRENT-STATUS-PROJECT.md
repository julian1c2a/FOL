...
| Total sorries | **0** — ⚠️ pero el de `Completeness` se sustituyó por 5 `axiom`, hoy **3** (`FOL.Enumeration` retiró dos el 2026‑09‑13) |
...
| `Completeness.lean` | 22 | 0 | ⚠️ **3 `axiom`** — eran 5 (ver `AXIOMS.md`) |
