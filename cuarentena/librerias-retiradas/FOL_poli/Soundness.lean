...
--
-- Dependencies: FOL_poli.FOL, FOL_poli.Metamath.Semantics, FOL_poli.Tactics
...
namespace FOL_poli.Metamath.Soundness
...
end FOL_poli.Metamath.Soundness

export FOL_poli.Metamath.Soundness (soundness)
