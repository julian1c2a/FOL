...
--
-- Dependencies: FOL_poli.FOL, FOL_poli.Semantics, FOL_poli.Soundness, FOL_poli.Completeness
...
namespace FOL_poli.Metamath.Compacity

open FOL_poli.Metamath.Semantics
open FOL_poli.Metamath.Completeness
open FOL_poli.Metamath.Soundness
...
end FOL_poli.Metamath.Compacity

export FOL_poli.Metamath.Compacity (consistency_of_satisfiable compactness_theorem)
