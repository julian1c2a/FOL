...
-- Dependencies: FOLPure.FOL
-- @axiom_system: classical
-- @importance: high

import FOLPure.FOL

namespace FOLPure.Metamath.Semantics
...
theorem replaceAt_soundness {D : Type} (M : Model D) (v : Nat → D) {f sub sub' : Formula} {p : Pos}
  ...
  | body p ih =>
    ...
    | .bottom | .atom _ _ | .impl _ _ | .and _ _ | .or _ _ =>
      simp only [getAt?] at hGet; exact absurd hGet (by simp)

end FOLPure.Metamath.Semantics
